...
{ CAPWAP_MSG_WTP_EVENT_RESPONSE,"WTP Event Response"},
{ CAPWAP_MSG_CHANGE_STATE_EVENT_REQUEST,"Change State Event Request"},
{ CAPWAP_MSG_CHANGE_STATE_EVENT_RESPONSE,"Change State Event Response"},
{ CAPWAP_MSG_ECHO_REQUEST,"Echo Request"},
{ CAPWAP_MSG_ECHO_RESPONSE,"Echo Response"},
{ CAPWAP_MSG_IMAGE_DATA_REQUEST,"Image Data Request"},
